                ...
                <div class="col-md-4" >
                    <div style="margin-top: 20%;">
                        <div class="shadow p-3 mb-5 bg-white rounded">
                            ...
                            <h3 class="text-primary"><center>Insira os valores para calcular: (U=R.I)</center></h3>
                            <br>
                            ...
                            if($_POST){
                                echo '<br><h4><center>Resultado do campo vazio: '.$calculadora->uri($_POST['r'], $_POST['u'], $_POST['i']).'</center></h4>';
                            }
                            ?>
                        </div>
                    </div>
